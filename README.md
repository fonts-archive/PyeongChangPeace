...
사용하는 `font-family`의 이름은 `Pyeong Chang Peace`입니다.
...
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/fonts-archive/PyeongChangPeace/subsets/PyeongChangPeace-dynamic-subset.css" type="text/css"/>
```

### CSS

```css
@import url('https://cdn.jsdelivr.net/gh/fonts-archive/PyeongChangPeace/subsets/PyeongChangPeace-dynamic-subset.css');
```
...
```css
font-family: "Pyeong Chang Peace", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Oxygen, Ubuntu, Cantarell, "Open Sans", "Helvetica Neue", sans-serif;
```
